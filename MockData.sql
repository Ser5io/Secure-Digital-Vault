...
(1, 'System_Config.xml', 'enc_001.dat', 'C:/Data/001.dat', 102400, NULL, 'ha1'), -- 100KB
(1, 'Admin_Report_Q1.pdf', 'enc_002.dat', 'C:/Data/002.dat', 5242880, NULL, 'ha2'); -- 5MB

-- ملفات عمر (Omar_User) - ملفات شخصية
INSERT INTO Files (user_id, original_name, stored_name, file_path, file_size, encryption_iv, file_hash) VALUES 
(2, 'My_Photo.jpg', 'enc_003.dat', 'C:/Data/003.dat', 2097152, NULL, 'ho1'), -- 2MB
(2, 'Reading_List.txt', 'enc_004.dat', 'C:/Data/004.dat', 5120, NULL, 'ho2'); -- 5KB

-- ملفات ليلى (Laila_Dev) - ملفات برمجة (كبيرة)
INSERT INTO Files (user_id, original_name, stored_name, file_path, file_size, encryption_iv, file_hash) VALUES 
(3, 'Source_Code_v1.zip', 'enc_005.dat', 'C:/Data/005.dat', 15728640, NULL, 'hl1'), -- 15MB
(3, 'Database_Dump.sql', 'enc_006.dat', 'C:/Data/006.dat', 104857600, NULL, 'hl2'); -- 100MB

-- ملفات يارا (Yara_Manager) - ملفات مالية
INSERT INTO Files (user_id, original_name, stored_name, file_path, file_size, encryption_iv, file_hash) VALUES 
(4, 'Budget_2026.xlsx', 'enc_007.dat', 'C:/Data/007.dat', 3145728, NULL, 'hy1'); -- 3MB

-- ملفات أحمد (Ahmed_Guest) - ملف واحد بسيط
INSERT INTO Files (user_id, original_name, stored_name, file_path, file_size, encryption_iv, file_hash) VALUES 
(5, 'Welcome_Guide.pdf', 'enc_008.dat', 'C:/Data/008.dat', 1048576, NULL, 'ha_g1'); -- 1MB
